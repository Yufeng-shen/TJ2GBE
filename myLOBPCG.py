...
def lobpcg(Ahalf, X,
    ...
    Parameters
    ----------
    Ahalf : {sparse matrix, dense matrix, LinearOperator}
        Ahalf^T.dot(Ahalf) is the symmetric linear operator of the problem, usually a
        sparse matrix. 
    X : array_like
    ...
    Examples
    --------
    Solve A^T A x = lambda B x with constraints and preconditioning.
